...
screen corredor:
    imagemap:
        ...
        hotspot(342, 174, 60, 56) action Return("quartoVisitaEsquerdo_puzzle")
        hotspot(475, 264, 56, 58) action Return("despensa_puzzle")
        hotspot(594, 378, 39, 40) action Return("quarto_infantil_puzzle")
        hotspot(865, 204, 65, 53) action Return("quartoVisitaDireito_puzzle")
